package org.soltalk.soltalk_backend.financial.controller;
...
import org.soltalk.soltalk_backend.financial.service.FinancialSummaryAnalyzer;
...
public class FinancialSummaryController {
    ...
    public ResponseEntity<List<CategorySpendingSummaryDTO>> getTop5Categories(@RequestParam("userId") int userId) {
        logger.info("getTop5Categories()...userId:{}", userId);
        List<CategorySpendingSummaryDTO> list = summaryAnalyzer.getTop5Categories(userId);
        if (!list.isEmpty()) {
    ...
    public ResponseEntity<List<CategorySpendingSummaryDTO>> getLast7DaysSpending(@RequestParam("userId") int userId) {
    ...
    public ResponseEntity<List<StoreSpendingSummary>> getCategoryDetails(@RequestParam("userId") int userId) throws URISyntaxException {
